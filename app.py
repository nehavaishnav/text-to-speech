...
Logo=PhotoImage(file="speak.png")
...
gender_combobox=Combobox(root,values=['Males','Female'],font="arial 14",state='r',width=10)
gender_combobox.place(x=550,y=200)
gender_combobox.set('Male')

speed_combobox=Combobox(root,values=['Fast','Normal','Slow'],font="arial",state ='r',width=10)
